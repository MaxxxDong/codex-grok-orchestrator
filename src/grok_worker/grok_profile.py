...
def prepare_isolated_profile(
    *,
    ...
    if os.name == "nt":
        child_environment["USERPROFILE"] = str(runtime_home)
        child_environment["HOMEDRIVE"] = runtime_home.drive
        child_environment["HOMEPATH"] = str(runtime_home)[len(runtime_home.drive) :]
